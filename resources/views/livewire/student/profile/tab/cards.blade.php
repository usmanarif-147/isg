<div>
    <div class="tab-pane fade min-vh-100" id="nav-cards" role="tabpanel" aria-labelledby="nav-cards-tab">
        ...
        <div class="d-flex justify-content-center align-items-center">
            <div class="modal fade" id="customModal1" aria-hidden="true" aria-labelledby="customModalLabel1"
                tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content p-2">
                        <div class="modal-body">
                            ...
                            <div class="">
                                <button class="btn w-100 btn-custom-bg open-custom-modal3"
                                    data-bs-target="#customModal3" data-bs-toggle="modal" data-bs-dismiss="modal">
                                    <div class="d-flex justify-content-center align-items-center">
                                        <div class="d-flex align-items-center gap-4">
                                            <div class="scan-by-qr">
                                                <img src="{{ asset('student/images/scan-by-nfc.svg') }}"
                                                    class="img-fluid" alt="">
                                            </div>
                                            <div>
            ...
            <div class="modal fade" id="customModal2" aria-hidden="true" aria-labelledby="customModalLabel2"
                tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="qr-code">
                                    <img src="{{ asset('student/images/QR-code.svg') }}" class="img-fluid"
                                        alt="">
                                </div>
                            </div>
            ...
            <div class="modal fade" id="customModal3" aria-hidden="true" aria-labelledby="customModalLabel3"
                tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <div class="qr-code">
                                    <img src="{{ asset('student/images/nfc.svg') }}" class="img-fluid"
                                        alt="">
                                </div>
                            </div>
            ...
            <a class="btn btn-custom-bg my-5 activate-custom-card d-flex gap-2 align-items-center"
                data-bs-toggle="modal" href="#customModal1" role="button">
                <div>
