                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="d-flex justify-content-between align-items-center my-4 gap-2">
                            ...
                            <div>
                                <p class="info-text fs-15 m-0">{{ $details->blood_group }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4">
                        <div class="d-flex justify-content-between align-items-center my-4 gap-2">
                            ...
                            <div>
                                <p class="info-text fs-15 m-0">{{ $details->dob }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="d-flex justify-content-between align-items-center my-4 gap-2">
                            ...
                            <div>
                                <p class="info-text fs-15 m-0">{{ $details->nationality }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4">
                        <div class="d-flex justify-content-between align-items-center mt-3 mb-0 gap-2">
                            ...
                            <div>
                                <p class="info-text fs-15 m-0">{{ $details->gender }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-lg-4">
